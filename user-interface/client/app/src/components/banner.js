    ...
    render(){
        ...
        return (
            <div id="bannerAlignment">
                <img src={sbu_logo} className="nav" alt="sbu-logo" style={{ width: "5%", height: "5%" }} onClick={() => this.props.toHomePage()}></img>
                <h1 id="bannerTitle" className="nav" onClick={this.props.toHomePage}>TDF-DFT for QM7 Molecules</h1>
